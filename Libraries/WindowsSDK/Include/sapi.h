...
// Use SAPI 5.3 by default if target Vista
...
// The following definitions are for SAPI 5.3
#if  _SAPI_VER >= 0x053
...
EXTERN_C const IID IID_ISpTranscript;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE AppendTranscript( 
            /* [string][in] */ __RPC__in LPCWSTR pszTranscript) = 0;
    ...
    typedef struct ISpTranscriptVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *AppendTranscript )( 
            ISpTranscript * This,
            /* [string][in] */ __RPC__in LPCWSTR pszTranscript);
...
/* interface __MIDL_itf_sapi_0001_0116 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_sapi_0001_0116_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_sapi_0001_0116_v0_0_s_ifspec;
