...
typedef /* [public][public][public][public][public][public][public][public] */ struct __MIDL_IWTSSBPlugin_0002
    {
...
EXTERN_C const IID IID_IWTSSBPlugin;
    ...
    public:
        ...
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE WTSSBX_GetMostSuitableServer( 
            /* [string][in] */ __RPC__in WCHAR *UserName,
            /* [string][in] */ __RPC__in WCHAR *DomainName,
            /* [string][in] */ __RPC__in WCHAR *ApplicationType,
            /* [string][in] */ __RPC__in WCHAR *FarmName,
